 ...
 */
export class PolyPell extends LitElement {
  ...
  _render() {
    return html`
      <style>
        ...
        #pell {min-height: 50vh;border: solid 1px #000000;background-color: #f7f7f7;}
        ...
        .pell-actionbar {height: 48px;box-sizing: content-box;}
        .pell-actionbar button {color: #000000;border: none;font-size: 1.2em;background-color: #fefefe;width: 48px;height: 48px;cursor: pointer;}
        .pell-actionbar button.pell-button-selected {font-weight: bold;color: var(--app-primary-color, royalblue);border-bottom: 4px solid var(--app-primary-color, royalblue);box-sizing: border-box;}
        .pell-content {min-height: 100%;height: 50vh;}
